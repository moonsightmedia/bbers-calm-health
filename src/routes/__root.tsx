...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Simone Rothlübbers begleitet Menschen und Unternehmen auf dem Weg zu mehr Gesundheit, Resilienz und Bewegung — ruhig, fundiert, persönlich." },
      { name: "author", content: "Simone Rothlübbers" },
      { property: "og:title", content: "Simone Rothlübbers — Ganzheitliche Gesundheit" },
      { property: "og:description", content: "Bewegung, Resilienz und persönliche Begleitung — für ein Leben in Balance." },
