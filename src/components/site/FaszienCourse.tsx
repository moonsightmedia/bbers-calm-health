...
import workshopYoga from "@/assets/workshop-yoga.jpg";
...
export function FaszienCourse() {
  return (
    <motion.div
      ...
      className="mb-16 overflow-hidden rounded-[28px] border border-deep/10 bg-card"
    >
      <div className="grid md:grid-cols-2">
        <div className="relative min-h-[280px] md:min-h-full">
          <img
            src={workshopYoga}
            alt="Simone Rothlübbers bei einer Bewegungsübung im Freien"
